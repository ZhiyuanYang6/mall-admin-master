  ...
  <div class="smain" @mouseover="Moveradd()">
    <el-form ref="formline" :model="formline" status-icon :rules="rules2" size="small" label-width="90px" :inline="true">
      ...
      <el-form-item label="商品售价" prop="spsj">
        <el-input v-model="formline.spsj" style="width:250px;"></el-input>
      </el-form-item>
      <el-form-item label="折扣率" prop="zkl">
        <el-input v-model="formline.zkl" style="width:250px;"></el-input>
      </el-form-item>
      <el-form-item label="折后价" prop="ggwzb">
        <el-input v-model="formline.ggwzb" style="width:250px;"></el-input>
      </el-form-item>
      <el-form-item label="备注" prop="ggbz">
        <el-input type="textarea" :rows=5 style="width:620px" v-model="formline.ggbz"></el-input>
      </el-form-item>
    </el-form>
    <span>广告图</span>
    <hr>
...
export default {
  ...
  methods: {
    ...
    subimage(file, url) {
      ...
      formdata1.append('ggwmc', this.formline.ggwmc);
      formdata1.append('ggwlx', this.formline.gglx);
      formdata1.append('ggwzb', this.formline.ggzb);
      formdata1.append('ggdx', this.ggtpsize);
      formdata1.append('ggbz', this.formline.ggbz);
      formdata1.append('ggwbz', this.formline.ggwbz);
