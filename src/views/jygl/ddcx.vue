  ...
  <div class="smain">
    ...
    <div class="stable">
      ...
      <el-table :data="tableData" @sort-change="sortChange" v-loading="loading" style="width:100%" border>
        ...
        <el-table-column prop="phone" label="商品序号" align="center"> </el-table-column>
        <el-table-column prop="title" label="图片" align="center"> </el-table-column>
        <el-table-column prop="txzt" label="商品编号" align="center"> </el-table-column>
        ...
        <el-table-column prop="bankCard" label="数量" align="center"> </el-table-column>
        <el-table-column prop="bankCard" label="优惠金额" align="center"> </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="mini" @click="onloadtable1()">详情</el-button>
